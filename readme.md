<h1>Desafio de projeto da DIO em NodeJS</h1>
...
<label for="jogadores-item">O Computador deve receber o sorteio de dois personagens que estão alocados em um vetor de players(objetos) para disputar a corrida em um objeto cada</label>
<hr>
<b>Pistas:</b>
...
<ul>
  ...
  <li> <label for="pistas-2-item">A cada rodada, será sorteado um bloco da pista que pode ser uma RETA, CURVA ou CONFRONTO</label>
    <ol>
      ...
      <li> <label for="pistas-2-3-item">Caso o bloco da pista seja um CONFRONTO, o jogador deve jogar um dado de 6 lados e somar o atributo PODER, quem perder, perde 1 ponto (🐢) ou 2 pontos (💣). O vencedor ganha 1 ponto (🍄)</label></li>
